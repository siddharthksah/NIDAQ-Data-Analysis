...
def animatex(i):
    ...
    xs1 = signal.savgol_filter(xs1, smooth_para, 2)
    xs2 = signal.savgol_filter(xs2, smooth_para, 2)
    xs3 = signal.savgol_filter(xs3, smooth_para, 2)
    xs4 = signal.savgol_filter(xs4, smooth_para, 2)
    xs5 = signal.savgol_filter(xs5, smooth_para, 2)
    xs6 = signal.savgol_filter(xs6, smooth_para, 2)
    xs7 = signal.savgol_filter(xs7, smooth_para, 2)
    xs8 = signal.savgol_filter(xs8, smooth_para, 2)
    xs9 = signal.savgol_filter(xs9, smooth_para, 2)
    xs10 = signal.savgol_filter(xs10, smooth_para, 2)
    xs11 = signal.savgol_filter(xs11, smooth_para, 2)
    xs12 = signal.savgol_filter(xs12, smooth_para, 2)
    xs13 = signal.savgol_filter(xs13, smooth_para, 2)
    xs14 = signal.savgol_filter(xs14, smooth_para, 2)
    xs15 = signal.savgol_filter(xs15, smooth_para, 2)
    xs16 = signal.savgol_filter(xs16, smooth_para, 2)
